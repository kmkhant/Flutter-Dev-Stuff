import 'package:destini_challenge_demo/story.dart';
...
class StoryBrain {
  ...
  List<Story> _storyData = [
    Story(
        storyTitle:
            'Your car has blown a 1tire on a winding road in the middle of nowhere with no cell phone reception. You decide to hitchhike. A rusty pickup truck rumbles to a stop next to you. A man with a wide brimmed hat with soulless eyes opens the passenger door for you and asks: "Need a ride, boy?".',
    ...
    Story(
        ...
        choice1: 'I love Elton1 John! Hand him the cassette tape.',
